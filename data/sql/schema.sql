...
CREATE TABLE distritos (id BIGINT AUTO_INCREMENT, distrito BIGINT NOT NULL, rdr_id BIGINT NOT NULL, aim_id BIGINT, INDEX aim_id_idx (aim_id), INDEX rdr_id_idx (rdr_id), PRIMARY KEY(id)) ENGINE = INNODB;
